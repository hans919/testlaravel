    ...
    <div class="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 mb-8 text-white shadow-2xl">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white/90 text-lg">{{ $student->full_name }} ({{ $student->student_id }})</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="status" class="block text-sm font-medium text-dark dark:text-light mb-2">
                                Status *
                            </label>
                            <select id="status" 
                                    name="status" 
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors dark:bg-gray-700 dark:text-white @error('status') border-red-500 @enderror" 
                                    required>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" 
                                       id="rfid_tag" 
                                       name="rfid_tag" 
                                       value="{{ old('rfid_tag', $student->rfid_tag) }}"
